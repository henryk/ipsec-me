# -*- coding: utf-8 -*-
#
# ipsec-me documentation build configuration file, created by
...
file_text = read(fpath('../ipsec_me/__meta__.py'))
...
latex_documents = [
    ('index', 'ipsec-me.tex', u'ipsec-me Documentation',
...
man_pages = [
    ('index', 'ipsec-me', u'ipsec-me Documentation',
        [u'Henryk Plötz'], 1)
]
...
texinfo_documents = [
    ('index', 'ipsec-me', u'ipsec-me Documentation',
        u'Henryk Plötz', 'ipsec-me', 'One line description of project.',
        'Miscellaneous'),
]
